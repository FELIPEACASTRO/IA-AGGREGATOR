...
class MistralModelProviderMockWebServerTest {
    ...
    void generate_shouldRetryAndEventuallySucceed() {
        ...
        MistralModelProvider provider = new MistralModelProvider(
                new ObjectMapper(),
        ...
        String response = provider.generate("hello", "mistral-small-latest");

        assertEquals("hello-from-mistral", response);
    ...
    void generate_shouldThrowAfterRetriesExhausted() {
        ...
        TechnicalException ex = assertThrows(TechnicalException.class,
                () -> provider.generate("hello", "mistral-small-latest"));
    ...
    void generate_shouldFailFastWhenCircuitBreakerIsOpen() {
        ...
        registry.circuitBreaker("aiProviderMistral").transitionToOpenState();
