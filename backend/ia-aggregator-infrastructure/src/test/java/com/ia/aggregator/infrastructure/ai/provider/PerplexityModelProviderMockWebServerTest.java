...
class PerplexityModelProviderMockWebServerTest {
    ...
    void generate_shouldRetryAndEventuallySucceed() {
        ...
        String response = provider.generate("hello", "sonar");

        assertEquals("hello-from-perplexity", response);
    ...
    void generate_shouldFailFastWhenCircuitBreakerIsOpen() {
        ...
        registry.circuitBreaker("aiProviderPerplexity").transitionToOpenState();
