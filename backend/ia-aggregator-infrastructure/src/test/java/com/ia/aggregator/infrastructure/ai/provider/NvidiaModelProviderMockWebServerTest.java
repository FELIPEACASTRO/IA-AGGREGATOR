...
class NvidiaModelProviderMockWebServerTest {
    ...
    void generate_shouldRetryAndEventuallySucceed() {
        ...
        NvidiaModelProvider provider = new NvidiaModelProvider(
                new ObjectMapper(),
        ...
        assertEquals("hello-from-nvidia", response);
    ...
    void generate_shouldFailFastWhenCircuitBreakerIsOpen() {
        ...
        registry.circuitBreaker("aiProviderNvidia").transitionToOpenState();
