...
class OpenRouterModelProviderMockWebServerTest {
    ...
    void generate_shouldRetryAndEventuallySucceed() {
        ...
        OpenRouterModelProvider provider = new OpenRouterModelProvider(
                new ObjectMapper(),
                ...
                2,
                10,
                List.of("openai/gpt-4o-mini")
        );

        String response = provider.generate("hello", "openai/gpt-4o-mini");

        assertEquals("hello-from-openrouter", response);
    ...
    void generate_shouldThrowAfterRetriesExhausted() {
        ...
        TechnicalException ex = assertThrows(TechnicalException.class,
                () -> provider.generate("hello", "openai/gpt-4o-mini"));
    ...
    void generate_shouldFailFastWhenCircuitBreakerIsOpen() {
        ...
        registry.circuitBreaker("aiProviderOpenrouter").transitionToOpenState();
