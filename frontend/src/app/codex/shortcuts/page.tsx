    ...
    <CodexShell title="Keyboard Shortcuts" subtitle="Fluxo keyboard-first para navegação e execução de tasks cloud.">
      <section className="rounded-[var(--radius-2xl)] border border-[var(--border)] bg-[var(--surface)] p-4">
        <ul className="space-y-2">
          {shortcuts.map((item) => (
            <li key={item.key} className="grid grid-cols-[180px_1fr] items-center gap-3 rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface-hover)] px-3 py-2 text-sm">
