-- ============================================================================
-- IA AGGREGATOR - PostgreSQL Database Schema
-- File: 00_extensions_and_types.sql
-- Purpose: Extensions, shared enum types, and utility functions
-- ============================================================================
...
-- Function to generate short unique IDs for share links
...
-- Function to get current user context for RLS
...
-- Function to get current org context for RLS
